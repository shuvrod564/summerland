...
<body> 
    ...
    <section class="py-5">
        <div class="container py-lg-4">
            <h1 class="h1 text-uppercase fw-bold text-center mb-4 mb-md-5">PVC Form Boards</h1> 
                    ...
                    <div class="product__card listing">
                        <figure class="text-center mb-0">
                            <img 
                                ...
                                alt="CRIZERAWUD 9mm"
                                width="419" height="419" loading="lazy"
                            >
                        </figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__card listing">
                        <figure class="text-center mb-0">
                            <img 
                                class="img-fluid transition w-100" 
                                src="<?php echo $base_url;?>assets/images/products/pvc-form-boards/crizerawud-18mm.webp" 
                                alt="CRIZERAWUD 18mm"
                                width="419" height="419" loading="lazy"
                            >
                        </figure>
                        <div class="caption px-3 py-3 d-flex justify-content-between align-items-center">
                            ...
                            <button value="CRIZERAWUD - CRIZERAWUD 18mm" class="btn btn-outline-white productEnquirBtn">ENQUIRE NOW</button>
                        </div>
                    </div>
                </div><!--.//col-->    
