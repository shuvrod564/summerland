                ...
                <div class="col-md-4">
                    <div class="d-flex contact__card align-items-center">
                        ...
                        <div class="caption">
                            ...
                            <a href="tel:+918891434381">+91 8891434381</a>
                        </div>
                    </div> 
                </div>
                <div class="col-md-4">
                    <div class="d-flex contact__card align-items-center">
                        ...
                        <div class="caption">
                            ...
                            <a href="mailto:info@summerland.co.in" class="text-lowercase">info@summerland.co.in</a>
                        </div>
                    </div>
                </div>
            </div><!--.//row--> 
        </div><!--.//container--> 
        <div class="border-top pt-4 pt-lg-5 mt-4 mt-lg-5">
            <div class="container">
            ...
            <div class="container"> 
                <div class="row g-2 align-items-center">
                    <div class="col-md-5 order-md-2">
                        <ul class="d-flex social__links justify-content-center justify-content-md-end">
                            <li>
                                <a class="d-flex justify-content-center align-items-center rounded" href="#" target="_blank">
                    ...
                    <div class="col-md-7 order-md-1"> 
                        <div class="text-center text-md-start mb-0 text-white fw-light fs-13">© Copyright <?php echo date('Y');?>. Developed by <a href="https://techpullers.com/website-dev.php" target="_blank" class="d-inline text-white text-capitalize">Techpullers</a></div>
                    </div>
                </div><!--.//row--> 
            </div>
        </div>
