        ...
        <div class="container">
                ...
                <div class="row g-4 gx-lg-5 align-items-center">
                    <div class="col-md-5">
                        <div class="thumbnail__box overflow-hidden"> 
                            <img src="assets/images/-products/flat-roof-tile/06.webp" class="img-fluid" alt="Image">
                        </div>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="product__card__lg">
                <div class="row g-4 gx-lg-5 align-items-center">
                    <div class="col-md-5">
                        <div class="thumbnail__box overflow-hidden"> 
                            <img src="assets/images/-products/flat-roof-tile/07.webp" class="img-fluid" alt="Image">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <h2 class="text-uppercase fw-semibold">Flat Roof tile</h2>
